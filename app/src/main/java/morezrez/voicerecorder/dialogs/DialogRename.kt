...
import morezrez.voicerecorder.databinding.RenameDialogBinding
...
class DialogRename(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dialog!!.window?.setBackgroundDrawableResource(morezrez.voicerecorder.R.drawable.dialog_frame)
    }
}
